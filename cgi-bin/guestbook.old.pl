...
$guestbookurl = "http://diloreto.com/guestbook/guestbook.html";
$guestbookreal = "/guestbook/guestbook.html";
$guestlog = "/guestbook/guestlog.html";
$cgiurl = "http://diloreto/cgi-bin/guestbook.pl";
...
$mailprog = '*!/usr/local/bin/perl';
$recipient = $ENV{'John@DiLoreto.com'};
...
sub no_redirection {
   ...
   print "<body><h1>Thank You For Signing The DiLoreto.com Guestbook</h1>\n";
